        ...
        <header className='absolute w-full z-50 transition-all duration-300'>
            <div className='container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20 '>
                ...
                <motion.div
                    ...
                    <div className='h-10 w-10 rounded-xl bg-gradient-to-r from-gray-500 to-gray-100 flex 
                    items-center justify-center text-purple-600 font-bold text-xl mr-3'>
                        A
                    </div>
                    <span className='text-xl font-bold bg-gradient-to-r from-gray-300 to-gray-100 
                ...
                <nav className='lg:flex  hidden space-x-8'>
                    {["Home", "About", "Projects", "Skill", "Contact"].map((item, index) => (
                        < motion.a
                            ...
                            className='relative text-gray-800 dark:text-gray-200 hover:via-violet-600
                        dark:hover:text-violet-400 font-medium transition-colors duration-300'
                            href="#">
                            {item}
                        ...
                        <form 
                            ...
                            <div>
                                ...
                                <input type="text"
                                    ...
                                    className='w-full px-4 py-2 border border-gray-600 rounded-lg focus:ring-2 focus:ring-violet-500
                            ...
                            whileTap={{scale:0.97}}
                            className='w-full px-4 py-2 bg-gradient-to-r from-violet-600 to-violet-400 hover:from-violet-700 hover:to-purple-700
